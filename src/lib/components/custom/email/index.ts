    ...
    <div style="padding: 20px 15px; background-color: #ffffff;">
      ...
      <div style="margin: 20px 0; text-align: center;">
        ...
        <div style="background-color: #ffffff; padding: 15px; display: inline-block; border: 2px solid #e2e8f0; border-radius: 8px;">
          ...
          <div style="margin-top: 10px; font-size: 12px; color: #a0aec0;">If you cannot see the QR code, please contact the event organizer.</div>
        </div>
      </div>
      ...
      <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 20px;">
        ...
        <div style="font-size: 15px;">
          <div style="margin: 8px 0;"><span style="color: #718096; display: inline-block; width: 100px;">Event:</span> <span style="font-weight: 500;">${event_name}</span></div>
          <div style="margin: 8px 0;"><span style="color: #718096; display: inline-block; width: 100px;">Date:</span> <span style="font-weight: 500;">${the_event_date.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} ${the_event_date.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true })}</span></div>
          <div style="margin: 8px 0;"><span style="color: #718096; display: inline-block; width: 100px;">Location:</span> <span style="font-weight: 500;">${event_location}</span></div>
        </div>
      </div>
