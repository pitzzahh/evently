...
import { AgendaDaysToShow, type CalendarEvent, EventItem, getAgendaEventsForDay } from '.';
				...
				days.map((day) => {
					...
					return (
						<div key={day.toString()} className="relative my-12 border-t border-border/70">
							<span
								className="data-today:font-medium absolute -top-3 left-0 flex h-6 items-center bg-background pe-4 text-[10px] uppercase sm:pe-4 sm:text-xs"
