...
export type AttendanceRecordsResponse<Texpand = unknown> = Required<AttendanceRecordsRecord> &
	BaseSystemFields<Texpand>;
export type EventSchedulesResponse<Texpand = unknown> = Required<EventSchedulesRecord> &
	BaseSystemFields<Texpand>;
...
export type ParticipantsResponse<Texpand = unknown> = Required<ParticipantsRecord> &
	BaseSystemFields<Texpand>;
export type QrCodesResponse<Texpand = unknown> = Required<QrCodesRecord> &
	BaseSystemFields<Texpand>;
