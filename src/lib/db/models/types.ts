...
export type EventSchedule = Pick<EventScheduleCollection, 'id' | 'event_id' | 'am_start' | 'am_end' | 'pm_start' | 'pm_end' | 'created' | 'updated'>;
export type EventDetails = Pick<EventDetailsCollection, 'id' | 'event_name' | 'is_multi_day' | 'event_date' | 'start_date' | 'end_date' | 'created' | 'updated'>;
