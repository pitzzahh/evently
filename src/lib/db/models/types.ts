...
export type EventDetails = Pick<EventDetailsCollection, 'id' | 'event_name' | 'type' | 'location' | 'description' | 'is_multi_day' | 'difference_in_days' | 'start_date' | 'end_date' | 'created' | 'updated' | 'settings'>;
